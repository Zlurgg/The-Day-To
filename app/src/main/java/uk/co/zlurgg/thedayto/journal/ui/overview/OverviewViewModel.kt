...
class OverviewViewModel(
    ...
    private fun updateGreeting() {
        ...
        val greetingList = when (hour) {
            in TimeConstants.NIGHT_START..TimeConstants.NIGHT_END ->
                GreetingConstants.NIGHT_GREETINGS // 12am - 4am
            in TimeConstants.MORNING_START..TimeConstants.MORNING_END ->
                GreetingConstants.MORNING_GREETINGS // 5am - 11am
            in TimeConstants.AFTERNOON_START..TimeConstants.AFTERNOON_END ->
                GreetingConstants.AFTERNOON_GREETINGS // 12pm - 4pm
            in TimeConstants.EVENING_START..TimeConstants.EVENING_END ->
                GreetingConstants.EVENING_GREETINGS // 5pm - 8pm
            else ->
                GreetingConstants.NIGHT_GREETINGS // 9pm - 11pm
        }
