...
object SampleEntries {
    val sampleEntry1 = Entry(
        ...
        dateStamp = LocalDate.now().minusDays(2).atStartOfDay().toEpochSecond(ZoneOffset.UTC),
        color = "#4CAF50",
        id = 1
    )
    ...
    val sampleEntry2 = Entry(
        ...
        dateStamp = LocalDate.now().minusDays(5).atStartOfDay().toEpochSecond(ZoneOffset.UTC),
        color = "#2196F3",
        id = 2
    )
    ...
    val sampleEntry3 = Entry(
        ...
        dateStamp = LocalDate.now().minusDays(10).atStartOfDay().toEpochSecond(ZoneOffset.UTC),
        color = "#FF9800",
        id = 3
    )
