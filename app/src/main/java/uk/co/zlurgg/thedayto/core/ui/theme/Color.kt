package uk.co.zlurgg.thedayto.core.ui.theme

import androidx.compose.ui.graphics.Color

// Warm, calming theme for mood tracking - inspired by soft pastels and nature
// Light Theme - Warm & Soft (reduced brightness for eye comfort)
val md_theme_light_primary = Color(0xFF7B6FA1)  // Soft purple - calm and reflective
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFE0D4F5)  // Muted lavender
...
val md_theme_light_secondaryContainer = Color(0xFFF0D0A0)  // Muted peach
...
val md_theme_light_tertiaryContainer = Color(0xFFC5E5DA)  // Muted mint
val md_theme_light_onTertiaryContainer = Color(0xFF00201A)
val md_theme_light_error = Color(0xFFBA1A1A)
val md_theme_light_errorContainer = Color(0xFFF5CCC8)  // Muted error container
val md_theme_light_onError = Color(0xFFFFFFFF)
val md_theme_light_onErrorContainer = Color(0xFF410002)
val md_theme_light_background = Color(0xFFF2EDE8)  // Soft warm gray
val md_theme_light_onBackground = Color(0xFF1F1B16)
val md_theme_light_surface = Color(0xFFF2EDE8)  // Soft warm gray
val md_theme_light_onSurface = Color(0xFF1F1B16)
val md_theme_light_surfaceVariant = Color(0xFFDED6CE)  // Muted warm beige
val md_theme_light_onSurfaceVariant = Color(0xFF4A4540)
val md_theme_light_outline = Color(0xFF7C7570)
val md_theme_light_inverseOnSurface = Color(0xFFEDE5DD)
val md_theme_light_inverseSurface = Color(0xFF34302A)
val md_theme_light_inversePrimary = Color(0xFFD5BAFF)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF7B6FA1)
val md_theme_light_outlineVariant = Color(0xFFC2BAB3)  // Slightly darker outline
...
val md_theme_dark_primaryContainer = Color(0xFF4A3D6A)
...
val md_theme_dark_secondaryContainer = Color(0xFF5A4232)
...
val md_theme_dark_tertiaryContainer = Color(0xFF3D5A50)
...
val md_theme_dark_surfaceVariant = Color(0xFF2E2A26)
val md_theme_dark_onSurfaceVariant = Color(0xFFB0A9A2)
